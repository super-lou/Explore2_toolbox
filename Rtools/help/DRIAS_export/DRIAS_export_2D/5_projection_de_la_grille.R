...
NCf$LambertParisII.name = "LambertParisII"
NCf$LambertParisII.dimension = ""
NCf$LambertParisII.precision = "integer"
NCf$LambertParisII.01.grid_mapping_name = "lambert_conformal_conic_1SP"
NCf$LambertParisII.02.latitude_of_origin = "52.f"
NCf$LambertParisII.03.central_meridian = "0.f"
NCf$LambertParisII.04.scale_factor = "0.9998774f"
NCf$LambertParisII.05.false_easting = "600000.f"
NCf$LambertParisII.06.false_northing = "2200000.f"
NCf$LambertParisII.07.epsg = "27572"
NCf$LambertParisII.08.references = "https://spatialreference.org/ref/epsg/ntf-paris-lambert-zone-ii/"
