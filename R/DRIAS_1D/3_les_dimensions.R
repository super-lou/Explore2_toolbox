...
station_codeHydro.name = "station_codeHydro"
station_codeHydro.dimension = "station"
station_codeHydro.precision = "char"
station_codeHydro.value = c("AAAAAAAA", "BBBBBBBB", "CCCCCCCC")
station_codeHydro.01.long_name = "code HYDRO"

### 2.3. station_name ________________________________________________
station_name.name = "station_name"
station_name.dimension = "station"
station_name.precision = "char"
station_name.value = c("La a sur a","La b sur b", "La c sur c")
station_name.01.long_name = "station name"

### 2.4. station_info ________________________________________________
station_info.name = "station_info"
station_info.dimension = "station"
station_info.precision = "integer"
station_info.value = 1:3
station_info.01.long_name = "some kind of station info"
...
alt.value = 1:length(station.value)
...
depth.value = 1:length(station.value)
