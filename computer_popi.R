...
# Work path
computer_work_path = '/home/vanille/library/Explore2_toolbox/'
# Library path for package dev
dev_lib_path = '/home/vanille/library/'
...
computer_data_path = '/home/vanille/data/Explore2'
